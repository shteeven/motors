...
function Product(unitID, make, model, year, summary, price, mileage, country, options, trim, fuel, transmission,
                 warranty, displacement, body, doors, engine, tuning) {
  this.unitID = unitID; // Product code
  this.make = make;
  this.model = model;
  this.year = year;
...
Store.prototype.getProduct = function (unitID) {
  for (var i = 0; i < this.Products.length; i++) {
    if (this.Products[i].unitID === unitID) {
